...
\begin{frame}[allowframebreaks]{On Teacher Model}
    ...
    \begin{itemize}
        ...
        \item \textbf{Observation:} InternVideo2.5 is a stronger teacher, but its student (TeachCLIP w/ InternVideo2.5) underperforms the X-CLIP baseline.
        \item \textbf{Cause:} Likely suboptimal hyperparameters (e.g., temperature, loss weights) during alignment.
        \item \textbf{Future Work:} Further tuning is required to better align with the new teacher's distribution.
    \end{itemize}
